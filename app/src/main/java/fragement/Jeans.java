...
import com.example.vaibhav.screen19.R;
...
public class Jeans extends Fragment {
    ...
    Integer pant[] = {R.drawable.pic, R.drawable.pic1, R.drawable.pic2,R.drawable.pic3,
            R.drawable.pic4, R.drawable.pic5,R.drawable.pic1,R.drawable.pic2};
    String tv1[] = {"$ 267","$ 345","$ 342","$ 356","$ 356","$ 342","$ 356","$ 356"};
    String tv2[] = {"Fit Jeans", "Good Jeans", "Jeans","Skinny Jeans","Skinny Jeans",
            "Jeans","Skinny Jeans","Skinny Jeans"};
    String tv3[] = {"NAVY BLUE WASHED MID","NAVY BLUE SOLID SKINNY", "BLUE WASHED LOW RISE SKINNY",
            "LIGHT BLUE ","LIGHT BLUE ", "BLUE WASHED LOW RISE SKINNY","LIGHT BLUE ","LIGHT BLUE "};
